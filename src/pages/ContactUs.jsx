          ...
          <div className="flex flex-col md:flex-row justify-between gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-6 md:mb-8 max-w-md">
                ...
                consectetur adipisicing elit. Architecto iste quaerat nobis
                dolor ipsa vel sit repellendus fuga optio deleniti labore amet
                animi quas in rem, quia modi nam cupiditate.
              </p>
            ...
            <div className="flex-1 max-w-full md:max-w-md">
              ...
              >
                <input
                  ...
                  className="mb-2 md:mb-3 px-4 py-3 rounded-lg bg-blue-100 focus:bg-white focus:outline-none focus:ring-0 border-0"
                />
                {errors.name && (
                ...
                <textarea
                  ...
                  value={form.message}
                  onChange={handleChange}
                  className="mb-2 md:mb-3 px-4 py-3 rounded-lg bg-blue-100 focus:bg-white focus:outline-none focus:ring-0 border-0 min-h-[100px]"
                />
                {errors.message && (
                  <span className="text-red-500 text-sm mb-2">
                    {errors.message}
